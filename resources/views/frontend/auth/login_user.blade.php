                ...
                <x-slot name="body">
                  <x-forms.post :action="route('frontend.auth.login')">
                    <div class="form-group">
                      <input type="password" name="pin_number" id="pin_number" class="form-control" placeholder="PIN" value="{{ old('pin_number') }}" maxlength="255" required autofocus autocomplete="pin" />
                    </div><!--form-group-->
